  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-[#5D5FEF] relative overflow-hidden">
        ...
        <Link
          href="/"
          className="relative z-10 flex items-center gap-2 font-bold text-2xl text-white"
        >
        ...
        <div className="relative z-10 space-y-6">
          <h2 className="text-5xl font-black text-white leading-[1.1]">
            Join the <br /> Workflow <br /> Revolution.
          </h2>
          <ul className="space-y-4 text-white/90 font-bold">
            <li className="flex items-center gap-3">
              <CheckCircle size={20} /> Secure File Processing
            </li>
            <li className="flex items-center gap-3">
              <CheckCircle size={20} /> 50+ Premium Tools
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md space-y-10">
          <div className="space-y-2">
            <h1 className="text-4xl font-[900] text-[#1A1A1A] tracking-tighter">
              Create Account
            </h1>
            <p className="text-slate-500 font-medium">
              Join 10,000+ users optimizing their work.
            </p>
          </div>
