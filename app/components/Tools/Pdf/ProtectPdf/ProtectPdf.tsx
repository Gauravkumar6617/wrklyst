    ...
    <div className="min-h-screen bg-[#F8FAFC] py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-12">
          <span className="px-4 py-1.5 bg-indigo-100 text-indigo-600 rounded-full text-xs font-black tracking-widest uppercase italic shadow-sm">
            Wrklyst Security
          </span>
              ...
              <div className="flex-1 bg-slate-50 relative">
                {previewUrl ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-slate-300 px-10 text-center">
                    ...
                    >
                      <FileLock2 size={80} strokeWidth={1} />
                    </motion.div>
                    <p className="font-bold text-lg text-slate-400 text-[#1E1F4B]">
                      Encryption requires a visual check
                    </p>
                    <p className="text-sm mt-2 font-medium opacity-60 max-w-xs">
                      Upload your document to confirm content before locking.
                    </p>
                  </div>
                )}
              </div>
              ...
              <AnimatePresence mode="wait">
                {!file ? (
                  ...
                  >
                    ...
                    />
                    <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-indigo-500/20 transition-all">
                  ...
                  >
                    <div className="bg-white/5 p-8 rounded-[32px] border border-white/10 backdrop-blur-sm">
                      <div className="flex items-center justify-between mb-6">
                        <label className="text-[11px] font-black uppercase text-indigo-400 tracking-[0.2em] block">
                          Set Vault Password
                        </label>
                        <button
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-[#1e1f4b] border-2 border-white/10 rounded-2xl p-5 text-white focus:border-indigo-500 transition-all outline-none placeholder:text-slate-600 font-bold text-lg mb-2"
                          value={password}
                      ...
                      <div className="flex gap-3 text-slate-400 text-[10px] leading-relaxed italic mt-4">
                        ...
                        <span>
                          Password must be remembered. We cannot recover lost
                          passwords.
                        </span>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className={`w-full py-7 rounded-[32px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-4 text-lg
                        ${isSuccess ? "bg-emerald-500 shadow-xl shadow-emerald-500/40 scale-[1.02]" : isProcessing ? "bg-slate-800" : "bg-indigo-600 hover:bg-indigo-700 active:scale-95 shadow-xl shadow-indigo-500/20"}
                      `}
                    >
                      {isSuccess ? (
                        <>
            ...
            <div className="px-10 py-6 bg-white rounded-[40px] border border-slate-100 flex items-center gap-4 shadow-sm">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-slate-500 font-medium leading-tight mt-1">
                  Files are automatically deleted after 60 mins.
                </p>
              </div>
            </div>
          </div>
