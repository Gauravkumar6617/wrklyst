      ...
      <div className="max-w-7xl mx-auto px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link
              href="/"
              className="flex items-center gap-2 font-bold text-xl text-[#2D2E5F]"
            >
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-[280px]">
              The all-in-one toolkit for file management. Process PDFs, images,
              and videos securely in your browser.
            </p>
            <div className="flex gap-4 text-slate-500">
              <Twitter
                size={20}
                className="hover:text-[#5D5FEF] transition-colors cursor-pointer"
              />
              <Github
                size={20}
                className="hover:text-[#5D5FEF] transition-colors cursor-pointer"
          ...
          {/* 2. Product Column */}
          <div>
            <h2 className="font-bold text-[#1A1A1A] mb-6 uppercase text-[11px] tracking-widest">
              Product
            </h2>
        ...
        <div className="pt-8 border-t border-slate-50 space-y-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-slate-600 text-xs font-medium">
            <p>© {currentYear} Wrklyst Inc. All rights reserved.</p>
            <div className="flex items-center gap-4 flex-wrap">
              <Link
                href="/privacy"
                className="hover:text-[#5D5FEF] transition-colors hover:underline"
              >
                Privacy Policy
              </Link>
